...
<CardGroup cols={2}>
  <Card title="Redux" icon="arrow-right" href="/state/redux-basics">
    Learn alternative state management with Redux
  </Card>
  <Card title="React Query" icon="arrow-right" href="/production/react-query">
    Better way to handle server state
  </Card>
  <Card title="Form Validation" icon="book" href="/advanced/forms-input">
